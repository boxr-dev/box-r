...
export const MiniChabakoLesson: React.FC = () => {
  return (
      ...
      <section className={style.section}>
        ...
        <div className={style.discription}>
          <div className={style['paragraph-wrapper']}>
            ...
            <Paragraph>手のひらサイズの茶箱の形をした桐箱を使用し、カルトナージュの技法で制作します。</Paragraph>
          </div>
          <div>
        ...
        <div>
          ...
          <div className={style.discription}>
            <Paragraph>講習費：¥3,500 ＋ 材料費</Paragraph>
            <div className={style['sub-paragraph']}>
              <Paragraph>※材料費は使用する生地や装飾により異なります。</Paragraph>
