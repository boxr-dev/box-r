...
export const FrenchMaisonDecorLesson: React.FC = () => {
  return (
    <div className={style.container}>
      <PageTitle title='Lesson' subTitle='カルトナージュ レッスン詳細' />
      <section className={style.section}>
        <SectionTitle title='フレンチメゾンデコール' subTitle='French Maison Decor' />
        <div className={style.discription}>
          <div className={style['paragraph-wrapper']}>
            <Paragraph>カルトナージュを中心にインテリアに関する手工芸を学びディプロマが取得できるコースです。</Paragraph>
        ...
        <div>
          ...
          <div className={style.discription}>
            <Paragraph>下記作品を作成します。</Paragraph>
            <ol className={style['curriculum-list']}>
              <li>タッセル３種『エクラ』『シャポードノア』『リュミエール』</li>
              <li>カルトナージュ『リボントレイ』</li>
              <li>カルトナージュ『ランプシェード』、ソフトファニシング『アロマオーナメント』</li>
              <li>カルトナージュ『ティッシュボックス』</li>
              <li>カルトナージュ『オーバルミラー』</li>
              <li>カルトナージュ『マガジンラック』</li>
            </ol>
          </div>
        </div>
        <div>
